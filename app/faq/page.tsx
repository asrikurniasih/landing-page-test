  ...
  const faqData = [
    {
      id: 1,
      category: "umum",
      question: "Apa itu Rusun Pasar Jaya?",
      answer: "Rusun Pasar Jaya adalah hunian sewa sederhana yang dikelola secara profesional, dengan fasilitas lengkap dan harga terjangkau bagi masyarakat. Kami menyediakan unit hunian berkualitas dengan standar yang memadai untuk kebutuhan keluarga."
    },
    {
      id: 2,
      category: "persyaratan",
      question: "Siapa saja yang bisa menyewa unit di Rusun?",
      answer: "Semua masyarakat yang memenuhi persyaratan administrasi, seperti KTP, KK, dan dokumen pendukung lainnya sesuai ketentuan pengelola. Kami menerima penyewa dari berbagai latar belakang dengan prioritas untuk keluarga berpenghasilan menengah ke bawah."
    },
    {
      id: 3,
      category: "proses",
      question: "Bagaimana cara mengajukan sewa unit?",
      answer: "Anda dapat mengajukan secara online melalui halaman Kontak/Registrasi di website ini, atau langsung datang ke kantor pengelola untuk konsultasi lebih lanjut. Proses pengajuan meliputi pengisian formulir, verifikasi dokumen, dan wawancara singkat."
    },
    {
      id: 4,
      category: "biaya",
      question: "Apa saja biaya yang perlu disiapkan?",
      answer: "Biaya sewa bulanan sudah termasuk pemakaian unit, sementara biaya listrik, air, dan layanan tambahan dibayarkan sesuai pemakaian masing-masing penghuni. Biaya awal meliputi uang jaminan dan uang muka sesuai ketentuan yang berlaku."
    },
    {
      id: 5,
      category: "pembayaran",
      question: "Bagaimana sistem pembayarannya?",
      answer: "Pembayaran sewa dapat dilakukan secara transfer bank, virtual account, atau metode lain yang disediakan oleh pengelola. Kami menyediakan berbagai opsi pembayaran yang mudah dan aman untuk kenyamanan penghuni."
    },
    {
      id: 6,
      category: "kontrak",
      question: "Apakah saya bisa berhenti menyewa sebelum kontrak habis?",
      answer: "Ya, penghuni dapat mengajukan pengakhiran sewa lebih awal dengan mengikuti prosedur pengelola, termasuk pemberitahuan minimal 30 hari sebelumnya. Biaya administrasi pengakhiran kontrak akan dikenakan sesuai ketentuan."
    },
    {
      id: 7,
      category: "keuntungan",
      question: "Apa keuntungan tinggal di Rusun Pasar Jaya?",
      answer: "Lokasi strategis dekat dengan pusat aktivitas, fasilitas lengkap dan terawat, harga sewa terjangkau, dan proses sewa mudah dan transparan. Kami juga menyediakan layanan 24/7 untuk keamanan dan kenyamanan penghuni."
    },
    {
      id: 8,
      category: "fasilitas",
      question: "Apa saja fasilitas yang tersedia?",
      answer: "Fasilitas yang tersedia meliputi area parkir, keamanan 24 jam, area bermain anak, ruang serbaguna, dan akses internet. Setiap unit dilengkapi dengan perabotan dasar dan sistem keamanan yang memadai."
    },
    {
      id: 9,
      category: "lokasi",
      question: "Di mana lokasi Rusun Pasar Jaya?",
      answer: "Rusun Pasar Jaya berlokasi strategis di pusat kota dengan akses mudah ke berbagai fasilitas umum seperti pasar, sekolah, rumah sakit, dan transportasi umum. Lokasi yang nyaman untuk aktivitas sehari-hari."
    },
    {
      id: 10,
      category: "maintenance",
      question: "Bagaimana sistem perawatan dan maintenance?",
      answer: "Kami memiliki tim maintenance profesional yang siap melayani kebutuhan perawatan unit dan fasilitas umum. Layanan maintenance tersedia 24/7 untuk kondisi darurat dan jadwal rutin untuk perawatan preventif."
    }
  ];
          ...
          <div className="max-w-2xl mx-auto">
            <div className="relative">
              ...
              <input
                ...
                className="block w-full pl-12 pr-4 py-3 border border-gray-300 rounded-lg text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#09893c] focus:border-transparent shadow-sm"
              />
            </div>
          </div>
        </div>
