          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="mb-6">
              ...
              <div className="flex space-x-4 flex-wrap">
                {configData?.footer_array?.sosmed?.map((social, index) => (
                  <a 
                    key={index}
                    href={social.link} 
                    target="_blank" 
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li className="flex items-start space-x-3">
                ...
                <span>{configData?.footer_array?.address || "Jakarta, Indonesia"}</span>
              </li>
              <li className="flex items-center space-x-3">
                <svg className="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <span>{configData?.footer_array?.phone || "+62 21 1234 5678"}</span>
              </li>
              <li className="flex items-center space-x-3">
                <svg className="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span>{configData?.footer_array?.email || "info@rusunawa.com"}</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 {configData?.company_name || "Rusun Pasar Jaya"}. Semua hak dilindungi.
            </p>
